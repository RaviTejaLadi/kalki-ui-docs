...
export default function SimpleCloseButton() {
  return <CloseButton onClick={() => console.log("Close button clicked")} />;
}
`,
...
export default function DisabledCloseButton() {
  return <CloseButton disabled onClick={() => console.log("This will not be called")} />;
}
`,
...
export const rows = [
  ...
  ['size', 'string', "'sm'", "The size of the button. Can be 'xs', 'sm', 'md', or 'lg'."],
