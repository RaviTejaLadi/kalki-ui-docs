...
`,
  ...
  },
  {
    ...
    code: `
import { Button, Paragraph, Ripple } from "kalki-ui";
...
export default function Example() {
  return (
    <Box style={{ width: "200px", height: "200px", position: "relative", overflow: "hidden" }}>
      <img
        src="https://picsum.photos/seed/ripple/200/200"
        alt="Example"
  ...
  return (
    <Box style={{ display: "flex", gap: "10px" }}>
      {["#e74c3c", "#3498db", "#2ecc71"].map((color, index) => (
        <Box width="100px" height="100px" backgroundColor={color} key={index} style={{ position: "relative" }} rounded>
          <Box
            height="100%"
            color="white"
            style={{
