 ...
 * This component is designed to be used with Recharts and provides
 * customizable options for displaying tooltip content.
 *
 * @component
 ...
 * @param {string} [props.label] - The label to display in the tooltip.
 ...
 * @param {string} [props.nameKey] - The key to use for the name in the payload.
 * @param {string} [props.labelKey] - The key to use for the label in the payload.
 * @param {React.Ref<HTMLDivElement>} ref - The ref to attach to the tooltip container.
 *
 * @returns {React.ReactElement | null} The rendered tooltip content or null if inactive.
 */
