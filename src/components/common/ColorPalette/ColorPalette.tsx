      ...
      <div className='flex items-end justify-between'>
        ...
        <div className="relative mt-4 flex items-center max-w-md">
          ...
          <Input
            ...
            className="block text-muted-foreground placeholder:text-xs text- w-[30rem] pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
          />
        </div>
      </div>
