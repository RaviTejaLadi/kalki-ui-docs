  ...
  },
  {
    ...
    components: [
      ...
      },
      {
        label: 'Toast',
        description:
          'Non-blocking, auto-dismissible notification mechanism for delivering transient feedback, status updates, or system messages with configurable display durations.',
  ...
  },
  {
    ...
    components: [
      ...
      },
      {
        ...
        path: '/components/stateManagment',
        Icon: Container,
      },
    ],
  },
